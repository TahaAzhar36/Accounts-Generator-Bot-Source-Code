...
module.exports = {
    ...
    execute(client, message){
        ...
        async function giveaway() {
            ...
            var time2 = '';
            var time3 = '';
            if(!message.member.hasPermission('MANAGE MESSAGES')) return message.channel.send('You don\'t have enough permissions to use this command.');
            if (message.content === `$giveaway`) return message.channel.send(`You didn\'t state a duration or a price for the giveaway.`)
            if (message.content !== `$giveaway`) {
                ...
                if (!isNaN(stated_duration_hours3)) {
                    ...
                    if (stated_duration_hours3 !== '0') {
                        ...
                        .setThumbnail('https://media.discordapp.net/attachments/790918902363717682/799322379742347354/lighter.png?width=738&height=492')
                        .setTitle(`${prize}`)
                        .setColor('36393F')
