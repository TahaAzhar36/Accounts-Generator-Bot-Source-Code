...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/disney.txt', 'utf8', function(err, data) {
            ...
            .setThumbnail('https://cdn.discordapp.com/attachments/790918902363717682/794984286217306152/AAUvwngZPF_mhp1bClkEFM3HD6weBtJWAYhe_O2wIp2kWXss900-c-k-c0x00ffffff-no-rj.png')
            .setColor("#363940")
